...
import { UserRO, UserWithFabricCredential } from './user.interface';
...
export class UserService {
  ...
  async findById(id: number): Promise<UserWithFabricCredential> {
    ...
    return this.buidUserWithFabricCredential(user);
  }
  ...
  private buidUserWithFabricCredential(user: UserEntity): UserWithFabricCredential {
    ...
    wallet.import(user.username, myIndentity)
    const userRO = {
      username: user.username,
      email: user.email,
      token: this.generateJWT(user),
